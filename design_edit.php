<?php
  include('config.php');
    $design = $_POST['design'];
    $stmt = $conn->query("SELECT * FROM design natural join color where design_id= '$design' ");
    $row = $stmt->fetch_assoc();
    if(!$row){
      echo
      "<script>
      alert('ไม่พบข้อมูลการออกแบบของคุณ');
  ...
  <body class="goto-here">
    ...
    <section id="designer" class="about">
      ...
      <div class="form-group d-flex">
        <input type="text" class="form-control" name="design" value="<?php echo $design; ?>"  placeholder="กรุณาใส่หมายเลขการออกแบบ เช่น NC2023222222342" required >
...
<footer class="ftco-footer bg-light ftco-section">
  ...
  <?php
require __DIR__.'/views/partials/customize_edit.php';
