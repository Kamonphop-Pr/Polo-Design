...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
          ...
          <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active"><a href="contact.php" class="nav-link text-primary" >ติดต่อเรา</a></li>
    ...
    <div class="hero-wrap hero-bread"  style="background-image: linear-gradient(to bottom, rgba(255, 255, 255, 0.6) 0%,rgba(255, 255, 255, 0.7) 100%), url(images/contact2.jpg);">
      <div class="container">
    ...
    <section class="ftco-section contact-section bg-light">
      <div class="container" >
      	<div class="row d-flex mb-5 contact-info" style="justify-content: center;">
          <div class="w-100"></div>
          <div class="col-md-3 d-flex" >
          	<div class="info bg-white p-4" style="width: 400px; height: 255px;">
	            <p  style="font-size:18px"><span>Address:</span> N&C</p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4" style="width: 400px; height: 255px;">
          ...
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4" style="width: 300px; height: 255px;">
	          </div>
          </div>
